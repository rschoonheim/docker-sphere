...
const (
	...
	// Logout RPC.
	AuthenticationServiceLogoutProcedure = "/authentication.v1.AuthenticationService/Logout"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	authenticationServiceServiceDescriptor      = v1.File_authentication_v1_authentication_proto.Services().ByName("AuthenticationService")
...
// Logout calls authentication.v1.AuthenticationService.Logout.
...
func (UnimplementedAuthenticationServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("authentication.v1.AuthenticationService.Login is not implemented"))
}
