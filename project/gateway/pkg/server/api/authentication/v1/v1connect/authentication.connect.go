...
const (
	...
	AuthenticationServiceName = "api.authentication.v1.AuthenticationService"
)
...
const (
	...
	// Login RPC.
	AuthenticationServiceLoginProcedure = "/api.authentication.v1.AuthenticationService/Login"
	// AuthenticationServiceLogoutProcedure is the fully-qualified name of the AuthenticationService's
	// Logout RPC.
	AuthenticationServiceLogoutProcedure = "/api.authentication.v1.AuthenticationService/Logout"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	authenticationServiceServiceDescriptor      = v1.File_api_authentication_v1_authentication_proto.Services().ByName("AuthenticationService")
...
// AuthenticationServiceClient is a client for the api.authentication.v1.AuthenticationService
// service.
...
// api.authentication.v1.AuthenticationService service. By default, it uses the Connect protocol
...
// Login calls api.authentication.v1.AuthenticationService.Login.
...
// Logout calls api.authentication.v1.AuthenticationService.Logout.
...
// api.authentication.v1.AuthenticationService service.
...
func NewAuthenticationServiceHandler(svc AuthenticationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.authentication.v1.AuthenticationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthenticationServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.authentication.v1.AuthenticationService.Login is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.authentication.v1.AuthenticationService.Logout is not implemented"))
}
