...
import (
	...
	context "context"
	docker "docker_sphere/project/systems/docker"
	errors "errors"
	http "net/http"
	strings "strings"
)
...
const (
	...
	DockerServiceName = "proto.systems.docker.v1.DockerService"
)
...
const (
	...
	// ListContainers RPC.
	DockerServiceListContainersProcedure = "/proto.systems.docker.v1.DockerService/ListContainers"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	dockerServiceServiceDescriptor              = docker.File_proto_systems_docker_v1_containers_proto.Services().ByName("DockerService")
	dockerServiceListContainersMethodDescriptor = dockerServiceServiceDescriptor.Methods().ByName("ListContainers")
)

// DockerServiceClient is a client for the proto.systems.docker.v1.DockerService service.
...
// NewDockerServiceClient constructs a client for the proto.systems.docker.v1.DockerService service.
...
// ListContainers calls proto.systems.docker.v1.DockerService.ListContainers.
...
// DockerServiceHandler is an implementation of the proto.systems.docker.v1.DockerService service.
...
func NewDockerServiceHandler(svc DockerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.systems.docker.v1.DockerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDockerServiceHandler) ListContainers(context.Context, *connect.Request[docker.ListContainersRequest]) (*connect.Response[docker.ListContainersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.systems.docker.v1.DockerService.ListContainers is not implemented"))
}
